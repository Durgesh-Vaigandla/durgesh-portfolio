...
const Contact: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Send to your backend API that handles Nodemailer
      ...
      setIsSubmitting(false);
      setError('Something went wrong. Please try emailing me directly at vaigandla.durgesh@gmail.com');
    }
  };
    ...
    >
      <div className="bg-glass border border-white/10 rounded-3xl p-6 md:p-12 backdrop-blur-md overflow-hidden relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 relative z-10">
          <div>
            <span className="text-accent font-mono text-xs font-bold tracking-wider uppercase mb-2 block">Available for Freelance</span>
            <h2 className="text-4xl md:text-5xl font-black text-white mb-6">Let's Build Something<br />Amazing.</h2>
            <p className="text-gray-400 mb-8 leading-relaxed">
              I help startups and businesses build scalable, high-performance web applications. 
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                ...
                <div>
                  <div className="text-xs text-gray-400 font-mono">Email Me</div>
                  <div className="font-bold text-sm md:text-base break-all">vaigandla.durgesh@gmail.com</div>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  <div className="text-xs text-gray-400 font-mono">Strategy Call</div>
                  <div className="font-bold">Book a Free 15-min Chat</div>
                </div>
              </a>
            </div>
          </div>
          ...
          <div className="bg-black/40 p-6 rounded-2xl border border-white/5">
            {!submitted ? (
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label className="text-xs font-mono text-gray-400 mb-2 block">Name</label>
                  <input 
                    type="text" 
                    name="user_name"
                    required
                ...
                <div>
                  <label className="text-xs font-mono text-gray-400 mb-2 block">Service Type</label>
                  <select 
                    name="service"
                    required
                    className="w-full bg-white/5 border border-white/10 rounded-lg p-3 text-base text-white focus:border-accent outline-none transition-colors appearance-none"
                  ...
                  >
                    <option value="" className="bg-black text-gray-500">Select Service</option>
                    ...
                    <option value="AI/ML Solutions" className="bg-black">AI/ML Solutions</option>
                    <option value="SEO & Growth" className="bg-black">SEO & Growth</option>
                ...
                <div>
                  <label className="text-xs font-mono text-gray-400 mb-2 block">Project Details</label>
                  <textarea 
                    name="message"
                    required
