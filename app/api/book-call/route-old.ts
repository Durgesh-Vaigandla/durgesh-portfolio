...
export async function POST(request: NextRequest) {
  try {
    ...
    const clientMailOptions = {
      from: `"Durgesh Vaigandla" <${process.env.EMAIL_USER}>`,
      to: email,
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f9f9f9; padding: 20px;">
          ...
          <div style="background: white; padding: 40px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
            ...
            <div style="text-align: center; padding: 20px 0; border-top: 1px solid #eee;">
              ...
              <a href="mailto:vaigandla.durgesh@gmail.com" style="display: inline-block; padding: 12px 30px; background: linear-gradient(135deg, #00f0ff 0%, #0099cc 100%); color: white; text-decoration: none; border-radius: 8px; font-weight: bold; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                Contact Me
              </a>
            </div>
            ...
            <p style="font-size: 16px; color: #333; line-height: 1.6; margin-top: 30px;">
              ...
              <span style="color: #00f0ff; font-size: 18px; font-weight: bold;">Durgesh Vaigandla</span><br>
